...
/* Buffer for UART1 */
#define P_BUFFER_ID_UART1            0
#define P_BUFFER_LENGTH_UART1        100

/* Buffer for Debug */
#define P_BUFFER_ID_Debug            1
#define P_BUFFER_LENGTH_Debug        100

/* Buffer for Diag_RecentEvents */
#define P_BUFFER_ID_Diag_RecentEvents            2
#define P_BUFFER_LENGTH_Diag_RecentEvents        10
...
#define UART1_Buffer_Create()             Buffer_Create(P_BUFFER_ID_UART1, BufferArray_UART1, P_BUFFER_LENGTH_UART1)
#define UART1_Buffer_Get()                Buffer_GetBuffer(P_BUFFER_ID_UART1)
#define UART1_Buffer_EnQueue(Data)        Buffer_EnQueue(P_BUFFER_ID_UART1, Data)
#define UART1_Buffer_DeQueue(Data)        Buffer_DeQueue(P_BUFFER_ID_UART1, Data)
#define UART1_Buffer_Length()             Buffer_Length(P_BUFFER_ID_UART1)
#define UART1_Buffer_Clear()              Buffer_Clear(P_BUFFER_ID_UART1)
#define UART1_IsBufferEmpty()             (UART1_Buffer_Length() == 0)
...
#define Diag_RecentEvents_Buffer_Create()             Buffer_Create(P_BUFFER_ID_Diag_RecentEvents, BufferArray_Diag_RecentEvents, P_BUFFER_LENGTH_Diag_RecentEvents)
#define Diag_RecentEvents_Buffer_Get()                Buffer_GetBuffer(P_BUFFER_ID_Diag_RecentEvents)
#define Diag_RecentEvents_Buffer_EnQueue(Data)        Buffer_EnQueue(P_BUFFER_ID_Diag_RecentEvents, Data)
#define Diag_RecentEvents_Buffer_DeQueue(Data)        Buffer_DeQueue(P_BUFFER_ID_Diag_RecentEvents, Data)
#define Diag_RecentEvents_Buffer_Length()             Buffer_Length(P_BUFFER_ID_Diag_RecentEvents)
#define Diag_RecentEvents_Buffer_Clear()              Buffer_Clear(P_BUFFER_ID_Diag_RecentEvents)
#define Diag_RecentEvents_IsBufferEmpty()             (Diag_RecentEvents_Buffer_Length() == 0)
...
extern UBYTE BufferArray_UART1[];
extern UBYTE BufferArray_Debug[];
extern UBYTE BufferArray_Diag_RecentEvents[];
